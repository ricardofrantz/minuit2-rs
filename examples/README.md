...
- `.github/workflows/scientific-demo-scheduled.yml` runs on a daily schedule and only auto-commits refreshed benchmark artifacts when the workflow runs on `master`.

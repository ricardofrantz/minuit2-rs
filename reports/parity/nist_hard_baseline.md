...
| --- | --- | --- | --- | --- |
| Lanczos3 | FAIL (valid=True, fval=3.3808e-05, params=False, nfcn=337) | FAIL (valid=True, fval=5.1388e-05, params=False, nfcn=226) | FAIL (valid=True, fval=0.00455507, params=False, nfcn=157) | FAIL (valid=True, fval=0.00455507, params=False, nfcn=157) |
| BoxBOD | OK (valid=True, fval=1168.01, params=True, nfcn=68) | OK (valid=True, fval=1168.01, params=True, nfcn=82) | OK (valid=True, fval=1168.01, params=True, nfcn=80) | OK (valid=True, fval=1168.01, params=True, nfcn=80) |
| MGH09 | FAIL (valid=True, fval=0.000494688, params=False, nfcn=177) | FAIL (valid=True, fval=0.000721538, params=False, nfcn=158) | FAIL (valid=True, fval=0.000948804, params=False, nfcn=71) | FAIL (valid=True, fval=0.000948804, params=False, nfcn=71) |
| Hahn1 | OK (valid=True, fval=1.53244, params=True, nfcn=581) | FAIL (valid=True, fval=44997.1, params=False, nfcn=580) | FAIL (valid=False, fval=51623.2, params=False, nfcn=74) | FAIL (valid=False, fval=47835.4, params=False, nfcn=324) |

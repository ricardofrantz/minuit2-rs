...
Aggregate C++ vs Rust solver timing (regenerate with
`examples/run_comparison.sh`; last run against v0.5.2):
...
**Wall-clock vs C++** is measured on the four scientific demo cases with a
